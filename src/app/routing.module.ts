...
const routes: Routes = [
  { outlet: 'outlet', path: '', component: DefaultOutletComponent }, // устанавливаем этот компонент для маршрутизатора ПО УМОЛЧАНИЮ
  { outlet: 'outlet', path: '1', component: Outlet1Component }, // устанавливаем этот компонент ДЛЯ ПЕРВОГО маршрутизатора
  { outlet: 'outlet', path: '2', component: Outlet2Component }, // устанавливаем этот компонент ДЛЯ ВТОРОГО маршрутизатора
